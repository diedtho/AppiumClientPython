...
class SimpleCalculatorTests(unittest.TestCase):
    ...
    def test_initialize(self):
        ...
        self.driver.find_element_by_name("Sieben").click()

        result = self.driver.find_element_by_accessibility_id("CalculatorResults")
        self.assertEqual(str(result.text), "Anzeige zeigt 7")

    def test_addition(self):
        self.driver.find_element_by_name("Eins").click()
        self.driver.find_element_by_name("Plus").click()
        self.driver.find_element_by_name("Sieben").click()
        self.driver.find_element_by_name("Ist gleich").click()

        result = self.driver.find_element_by_accessibility_id("CalculatorResults")
        self.assertEqual(str(result.text), "Anzeige zeigt 8")
